...
Senior software engineer working on **backend systems** and **platform engineering**.
...
class Parth:
    def __init__(self):
        ...
        self.focus = ["Backend Systems", "Platform Engineering"]
        self.years = 5
        self.stack = ["Go", "Python", "AWS", "Kafka", "PostgreSQL", "MongoDB", "Redis", "Docker"]
